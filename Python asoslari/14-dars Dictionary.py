...
print(f"Otam {otam['ism'].title()} {tyil}-yilda {vil.title()} viloyatida tug'ilgan")
...
jumla = python_dictionary.get(input("Python bo'yicha biror so'z kiriting>>>"), "Bunday so'z mavjud emas")
print(jumla)
...
if jumla in python_dictionary:
    print(f"Python dasturlash tilida {jumla} so'zi {python_dictionary[jumla]} ni bildiradi")
else:
